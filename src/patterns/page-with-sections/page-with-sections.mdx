...
[app view](?path=/docs/components-layout-app-view--docs) zet de achtergrond en
...
[simple section](?path=/docs/components-layout-page-sections-simple-section--docs)
...
[title](?path=/docs/components-content-title--docs) is hoe hij eruitziet,
...
[pagina](?path=/docs/components-layout-page--docs) kan zijn header laten
meelopen, maar standaard doet hij dat niet: elke balk die blijft staan, kost
ruimte die de inhoud nodig heeft. Zie de
[ontwerprichtlijnen](?path=/docs/docs-ontwerprichtlijnen--docs#visueel-en-layout).
...
[side-by-side split view](?path=/docs/components-layout-split-views-side-by-side-split-view--docs)
...
[titelbalk](?path=/docs/components-navigation-top-title-bar--docs) rendert
...
[pagina](?path=/docs/components-layout-page--docs) in een paneel houdt die niet
...
statusbalk, is er de
[bar split view](?path=/docs/components-layout-split-views-bar-split-view--docs).
...
[skip link](?path=/docs/components-navigation-skip-link--docs) bovenaan als er
...
[content-page](https://github.com/NederlandseDigitaleDienst/design-system/blob/main/skills/nldd-design-build/examples/content-page.md).
