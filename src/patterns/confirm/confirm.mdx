...
keuze is een [notification](?path=/docs/components-status-feedback-notification--docs)
of een [banner](?path=/docs/components-status-feedback-banner--docs). En liever
dan een modal: een [popover](?path=/docs/components-layout-popover--docs) die
aan de actie vastzit en de pagina niet afdekt. De afwegingen staan in de
[ontwerprichtlijnen](?path=/docs/docs-ontwerprichtlijnen--docs#feedback-en-state).
...
[inline dialog](?path=/docs/components-status-feedback-inline-dialog--docs):
...
[modal dialog](?path=/docs/components-status-feedback-modal-dialog--docs) zet
