...
[tabel](?path=/docs/components-lists-tables-table--docs). Gaat het om een handvol
gelijkwaardige blokken met een afbeelding of veel tekst, dan is het een
[collection](?path=/docs/components-layout-collection--docs) met kaarten.
...
[cel](?path=/docs/components-lists-tables-cells-text-cell--docs) bepaalt
lettertype, grootte, kleur en uitlijning, afgestemd op de rij. Kale tekst krijgt
daar niets van mee, en de
[rij](?path=/docs/components-lists-tables-list-item--docs) waarschuwt er in
...
[segment](?path=/docs/components-lists-tables-list-item-segment--docs) en laat
...
[lijst](?path=/docs/components-lists-tables-list--docs). Dat zijn twee
